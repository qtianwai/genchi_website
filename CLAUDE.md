...
`需求文档&技术方案/产品功能清单.md` 是产品开发的核心牵引文档，记录所有已完成和待开发功能。

**更新时机：**
当涉及以下变更时，必须同步更新该文档：
- 新功能开发完成（从待开发表格移至已完成表格）
- 新增待开发功能（添加到待开发表格）
- 功能调整或删除（更新对应表格行或删除）
- 技术实现方案变更（更新对应列）

**更新要求：**
- 保持两张表格的形式不变（已完成功能、待开发功能）
- 每行包含：功能名称、定位、核心解决的问题、关键要点、技术实现方案、优先级说明
- 技术实现方案需简化说明，不超过一行
- 保持文档直观简洁，让人一眼看懂产品全貌
- 新增或调整功能时，必须评估其优先级，并按优先级从高到低排序插入对应表格
